       ...
       {/* NỘI DUNG XỔ XUỐNG */}
        {openMoney && (
          <div className="w-full  h-full  p-[12px] bg-gray-100 rounded shadow text-left fade-in-invest">
            <p className="text-base font-bold mb-2 text-black">Lợi nhuận đến 15,5%/năm</p>
            ...
            <p className="text-sm mb-2 text-black">Với sản phẩm "Tài trợ Vốn", Nhà đầu tư được kết nối trực tiếp với khách hàng sở hữu ô tô có nhu cầu vay vốn, giúp tối ưu hiệu quả đầu tư và dòng tiền.</p>
             <div className="text-sm flex gap-2 mt-2 bg-[#ffd0b363] rounded">
                <img
                    ...
                    className="h-full "
                    />
                    <span className="flex font-bold text-black ">Số tiền đầu tư tối thiểu:</span> <p className="text-sm  text-black ">20,000,000 VNĐ</p>
            </div>
            <div className="text-sm flex gap-2 mt-2">
                <img
                    ...
                    className="h-full "
                    />
                    <span className="flex font-bold text-black ">Kỳ hạn linh hoạt:</span> <p className="text-sm  text-black ">1 – 60 tháng, dễ dàng tái đầu tư.</p>
            </div>
        ...
        {openSalaryAdvance && (
         <div className="w-full  h-full  p-[12px] bg-gray-100 rounded shadow text-left fade-in-invest text-black">
            <p className="text-base font-bold mb-2 text-black">Tài trợ Ứng Lương - Lợi nhuận lên tới 11%/năm</p>
            <div className="text-sm flex gap-2 h-full mb-2">
                <img
                    src={icomMember}
                    alt="icon"
            ...
            <p className="text-sm mb-2 text-black">Với Sản phẩm "Tài trợ Ứng lương", Nhà đầu tư được kết nối trực tiếp đến Người Lao Động có nhu cầu ứng trước một phần thu nhập dựa trên ngày công đã hình thành nhưng chưa đến kỳ nhận lương</p>
             <div className="text-sm flex gap-2 mt-2 bg-[#ffd0b363] rounded">
                <img
                    src={iconMoney}
                    alt="icon"
                    className="h-full "
                    />
                    <span className="flex font-bold text-black">Số tiền đầu tư tối thiểu:</span> <p className="text-sm  text-black ">500,000 VNĐ</p>
            </div>
            <div className="text-sm flex gap-2 mt-2">
                <img
                    src={iconCalendar}
